...
-- 正在导出表  simpleapp_development.roles 的数据：~2 rows (大约)
...
-- 正在导出表  simpleapp_development.rules 的数据：~2 rows (大约)
...
-- 正在导出表  simpleapp_development.users 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` (`id`, `name`, `gender`, `age`, `avatar`, `encrypt_password`, `password_salt`, `role_id`, `created_at`, `updated_at`) VALUES
	(1, 'testuser21', 0, 22, '211110.jpg', NULL, NULL, NULL, '2016-10-18 03:17:31', '2016-10-18 03:17:31');
